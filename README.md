...
Antes de entrar a (2)/(3), si quedó algún modelo `no_encontrado` en (1), `run.sh` pregunta explícitamente si se quiere intentar (límite de 15\,s; sin respuesta, o en una corrida no interactiva sin terminal, continúa igual -- nunca bloquea una corrida desatendida).
