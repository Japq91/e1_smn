...
\node[box] (S04) at (0,-11.7) {04\\Grilla com\'un};
\node[boxaux] (NB) at (4.6,-11.7) {Notebook\\gr\'aficos\\explorat.};

% A partir de 05, las cajas restantes se acomodan de a tres por fila
% (serpenteando izquierda-derecha-izquierda) en vez de una sola columna
% vertical, para no alargar innecesariamente la figura.
\node[box] (S05) at (-4.6,-13.6) {05\\M\'ascara oc\'eano-tierra};
\node[box] (S06) at (0,-13.6) {06\\Control de calidad};
\node[box] (S07) at (4.6,-13.6) {07\\Inventario final};
\node[box] (S08) at (4.6,-15.5) {Registro de\\modelos};
\node[box] (S09) at (0,-15.5) {Gr\'aficos\\autom\'aticos};
\node[box] (S10) at (-4.6,-15.5) {Reporte +\\paquete final};
...
\draw[edg] (S08) -- (S09);
\draw[edg] (S09) -- (S10);
\draw[edgd] (S05) to[bend left=15] (NB);
