...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Entregable N°1 -- Influencia del cambio climático en los eventos de El Niño y sus impactos en el Perú}
...
% ============================================================
% PORTADA  (mismo formato que la tapa de los informes previos)
% ============================================================
\begin{titlepage}
\centering
...
\vspace{0.3cm}
{\large \bfseries Servicio de asistencia en temas de investigaci\'on para evaluar\\
la influencia del cambio clim\'atico en los eventos de El Ni\~no\\
y sus impactos en el Per\'u \par}

\vspace{1.4cm}
{\small Prestado para: Servicio Nacional de Meteorolog\'ia e Hidrolog\'ia del Per\'u -- SENAMHI \par}

\vspace{1.4cm}
{\normalsize \bfseries Actividad: \par}
\vspace{0.2cm}
{\normalsize Primer entregable - Informe del desarrollo de la actividad a)\\
...
\midrule
E2 & Climatolog\'ia y ciclo anual observado vs.\ modelado; mapas de sesgo; correcci\'on de sesgo (Linear Scaling) y m\'etricas estad\'isticas (diagrama de Taylor) sobre los eventos c\'alidos extremos del ENOS mediante ONI/RONI (Ni\~no~3.4) e ICEN (Ni\~no~1+2), para seleccionar los modelos con mejor capacidad de representaci\'on del ENOS. \\
...
\begin{itemize}
\item Al iniciar el Entregable~2, evaluar primero la representatividad f\'isica y estad\'istica del ENOS en el conjunto de 40 modelos completos (correcci\'on de sesgo, ONI/RONI en Ni\~no~3.4, ICEN en Ni\~no~1+2, diagrama de Taylor espec\'ificamente sobre ambas cajas) antes de dar por buena su idoneidad solo por haber pasado el control de calidad de este entregable, que verifica homogeneizaci\'on y no desempe\~no clim\'atico (Secci\'on~\ref{sec:alcance}).
